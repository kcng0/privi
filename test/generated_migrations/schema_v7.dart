...
class MediaItems extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> sourcePlatformId = GeneratedColumn<String>(
      'source_platform_id', aliasedName, true,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      $customConstraints: 'NULL');
  late final GeneratedColumn<int> sourceRemovalPending = GeneratedColumn<int>(
      'source_removal_pending', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      $customConstraints:
          'NOT NULL DEFAULT 0 CHECK (source_removal_pending IN (0, 1))',
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<String> contentDigest = GeneratedColumn<String>(
      'content_digest', aliasedName, true,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      $customConstraints: 'NULL');
  @override
...
class AlbumGroups extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AlbumGroups(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'album_groups';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Never map(Map<String, dynamic> data, {String? tablePrefix}) {
  ...
  @override
  AlbumGroups createAlias(String alias) {
    return AlbumGroups(attachedDatabase, alias);
  }
...
class DatabaseAtV7 extends GeneratedDatabase {
  ...
  late final AlbumGroups albumGroups = AlbumGroups(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [mediaItems, albums, albumMedia, albumGroups];
  @override
